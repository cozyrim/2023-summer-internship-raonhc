...
file = 'checker01.jpg'  ## 체스 보드 이미지
dist_file = 'checker02.png'  ## 왜곡된 이미지 (같은 화각으로 찍은 이미지)
...
if ret == True:
    ...
    corners2 = cv2.cornerSubPix(gray, corners, (10, 10), (-1, -1), criteria) ## Canny86 알고리즘으로도형이 겹치는 코너 점을 찾는다
